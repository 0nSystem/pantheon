...
public class MapperRoleLanguageEntity {
    ...
    public static Function<CreateRoleLanguageDTO, RoleLanguageEntity> toEntity(final int roleId) {
    ...
    public static Function<RoleLanguageEntity, RoleLanguageDTO> toDto() {
